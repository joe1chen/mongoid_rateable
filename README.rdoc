...
{<img src="https://secure.travis-ci.org/joe1chen/mongoid_rateable.png?branch=mongoid2" />}[http://travis-ci.org/joe1chen/mongoid_rateable]

This branch of Mongoid:Rateable supports mongoid 2.
